...
- Scope: Phase 6X4 PRODUCTPOLICY worker row 6AI-001
...
- Effect: CLOSED_NO_PLATFORM_SINK
- Confidence: **CLOSED_NO_PLATFORM_SINK**; status `CLOSED_NO_PLATFORM_SINK`
- Scope: Phase 6X4 PRODUCTPOLICY worker row 6AI-002
...
- Effect: CLOSED_NO_PLATFORM_SINK
- Confidence: **CLOSED_NO_PLATFORM_SINK**; status `CLOSED_NO_PLATFORM_SINK`
- Scope: Phase 6X4 PRODUCTPOLICY worker row 6AI-003
...
- Effect: CLOSED_NO_PLATFORM_SINK
- Confidence: **CLOSED_NO_PLATFORM_SINK**; status `CLOSED_NO_PLATFORM_SINK`
- Scope: Phase 6X4 PRODUCTPOLICY worker row 6AI-004
...
- Scope: Phase 6X4 PRODUCTPOLICY worker row 6AI-005
...
- Scope: Phase 6X4 PRODUCTPOLICY worker row 6AI-006
...
- Scope: Phase 6X4 PRODUCTPOLICY worker row 6AI-007
...
- Confidence: **STATIC_LIFECYCLE_SINK_CALLER_AND_USER_UNKNOWN**; status `STATIC_LIFECYCLE_SINK_CALLER_AND_USER_UNKNOWN`
- Scope: Phase 6X4 USERSCOPE worker row 6AE-001
...
- Confidence: **STATIC_SETTINGS_SINK_USER_UNKNOWN**; status `STATIC_SETTINGS_SINK_USER_UNKNOWN`
- Scope: Phase 6X4 USERSCOPE worker row 6AE-002
...
- Confidence: **STATIC_AUTHORIZATION_ANOMALY_CANDIDATE_CALLER_USER_UNKNOWN**; status `STATIC_AUTHORIZATION_ANOMALY_CANDIDATE_CALLER_USER_UNKNOWN`
- Scope: Phase 6X4 USERSCOPE worker row 6AE-006
...
- Scope: Phase 6X4 PERMISSION worker row 6AK-001
...
- Effect: Declaration has raw protectionLevel=0x0 (normal); declaration alone is not requester or reachability proof
- Confidence: **UNKNOWN_NOT_CLOSED**; status `UNKNOWN_NOT_CLOSED`
- Scope: Phase 6X4 PERMISSION worker row 6AK-002
...
- Confidence: **UNKNOWN_NOT_CLOSED**; status `UNKNOWN_NOT_CLOSED`
- Scope: Phase 6X4 PERMISSION worker row 6AK-003
...
- Confidence: **UNKNOWN_NOT_CLOSED**; status `UNKNOWN_NOT_CLOSED`
- Scope: Phase 6X4 PERMISSION worker row 6AK-004
...
- Scope: Phase 6X4 PERMISSION worker row 6AK-005
...
- Effect: Bounded source corpus contains H2 AIDL implementation but no USE_SDK requester/consumer; negative is corpus-scoped
- Confidence: **BOUNDED_NEGATIVE_NOT_GLOBAL**; status `BOUNDED_NEGATIVE_NOT_GLOBAL`
- Scope: Phase 6X4 PERMISSION worker row 6AK-006
...
- Confidence: **BOUNDED_NEGATIVE_NOT_GLOBAL**; status `BOUNDED_NEGATIVE_NOT_GLOBAL`
- Scope: Phase 6X4 PERMISSION worker row 6AK-007
...
- Confidence: **BOUNDED_NEGATIVE_NOT_GLOBAL**; status `BOUNDED_NEGATIVE_NOT_GLOBAL`
- Scope: Phase 6X4 PERMISSION worker row 6AK-008
...
- Scope: Phase 6X4 PERMISSION worker row 6AK-009; raw CSV had 18 fields; exported-service/signature fields merged
...
- Scope: Phase 6X4 PERMISSION worker row 6AK-010; raw CSV had 14 fields; missing caller/scope/status columns set UNKNOWN or explicit reconciliation status
...
- Confidence: **POSITIVE_STATIC_SINK_CALLER_UNKNOWN**; status `POSITIVE_STATIC_SINK_CALLER_UNKNOWN`
- Scope: Phase 6X4 PERMISSION worker row 6AK-011; raw CSV had 18 fields; downstream-sink fields merged
...
- Scope: Phase 6X4 PERMISSION worker row 6AK-012
...
- Scope: Phase 6X4 OTA worker row 6AL-OTA-001
...
- Confidence: **closure**; status `closure`
- Scope: Phase 6X4 OTA worker row 6AL-OTA-002
...
- Confidence: **closure**; status `closure`
- Scope: Phase 6X4 OTA worker row 6AL-OTA-003
...
- Confidence: **closure**; status `closure`
- Scope: Phase 6X4 OTA worker row 6AL-OTA-004
...
- Confidence: **closure**; status `closure`
- Scope: Phase 6X4 OTA worker row 6AL-OTA-005
...
- Confidence: **closure**; status `closure`
- Scope: Phase 6X4 OTA worker row 6AL-OTA-006
...
- Scope: Phase 6X4 OTA worker row 6AL-OTA-007
...
- Confidence: **negative**; status `negative`
- Scope: Phase 6X4 OTA worker row 6AL-OTA-008
