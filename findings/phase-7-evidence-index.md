...
- Scope: Phase 7 SOURCE worker row 7A-SCOPE-001; missing_edge=No exact installed-target join beyond existing PS7330/PS7331 version boundary
...
- Confidence: **CONFIRMED**; status `CONFIRMED`
- Scope: Phase 7 SOURCE worker row 7A-SCOPE-002; missing_edge=No complete source-to-shipped-system/userspace build/output manifest
...
- Scope: Phase 7 SOURCE worker row 7A-SCOPE-003; missing_edge=Missing source-to-OTA-installer provenance and installer caller/gate join
...
- Confidence: **CONFIRMED**; status `CONFIRMED`
- Scope: Phase 7 SOURCE worker row 7A-SCOPE-004; missing_edge=Source build inputs and exact OTA member generation/signing provenance remain unjoined
...
- Scope: Phase 7 SOURCE worker row 7A-SCOPE-005; missing_edge=No new caller/authorization evidence in source bundle
...
- Scope: Phase 7 SOURCE worker row 7A-SCOPE-006; missing_edge=No full reproducible source-to-signed-Image attestation and no exact PS7330 signed binary
...
- Scope: Phase 7 SOURCE worker row 7A-SCOPE-007; missing_edge=Exact shipped caller → gate → sink/runtime identity absent
...
- Scope: Phase 7 SOURCE worker row 7A-SCOPE-008; missing_edge=VERSION_BOUNDARY_UNKNOWN
...
- Confidence: **unknown**; status `unknown`
- Scope: Phase 7 IPC worker row P7B-001; missing_edge=caller UID plus permission grant plus target-user validation plus observed process effect
...
- Scope: Phase 7 IPC worker row P7B-002; missing_edge=service-manager/SELinux reachability to accepted external caller
...
- Confidence: **unknown**; status `unknown`
- Scope: Phase 7 IPC worker row P7B-003; missing_edge=external tx3 caller identity and downstream cross-user authorization
...
- Scope: Phase 7 IPC worker row P7B-004; missing_edge=User-0 restoration edge or accepted ordinary caller absent
...
- Confidence: **bounded-negative**; status `bounded-negative`
- Scope: Phase 7 IPC worker row P7B-005; missing_edge=exact User-0 caller-to-setter edge
...
- Confidence: **duplicate**; status `duplicate`
- Scope: Phase 7 IPC worker row P7B-006; missing_edge=downstream PMS exact permission and caller-to-owner join
...
- Confidence: **bounded-negative**; status `bounded-negative`
- Scope: Phase 7 IPC worker row P7B-007; missing_edge=external API caller and exact package-state sink join
...
- Confidence: **bounded-negative**; status `bounded-negative`
- Scope: Phase 7 IPC worker row P7B-008; missing_edge=callback caller provenance and downstream HOME/package writer
...
- Confidence: **duplicate**; status `duplicate`
- Scope: Phase 7 IPC worker row P7B-009; missing_edge=service publication plus accepted caller runtime edge
...
- Confidence: **duplicate**; status `duplicate`
- Scope: Phase 7 IPC worker row P7B-010; missing_edge=transaction code plus service publication plus caller reachability
...
- Confidence: **bounded-negative**; status `bounded-negative`
- Scope: Phase 7 IPC worker row P7B-011; missing_edge=downstream key event consumer and settings/provider write
...
- Confidence: **bounded-negative**; status `bounded-negative`
- Scope: Phase 7 IPC worker row P7B-012; missing_edge=callback-to-settings key plus external provider caller mapping
...
- Confidence: **unknown**; status `unknown`
- Scope: Phase 7 IPC worker row P7B-013; missing_edge=production caller plus permission holder plus HOME-related key-to-sink edge
...
- Confidence: **bounded-negative**; status `bounded-negative`
- Scope: Phase 7 IPC worker row P7B-014; missing_edge=observer consumer provenance and downstream writer
...
- Confidence: **unknown**; status `unknown`
- Scope: Phase 7 IPC worker row P7B-015; missing_edge=actual bind caller plus service publication/SELinux boundary
...
- Confidence: **UNKNOWN**; status `UNKNOWN`
- Scope: Phase 7 KERNEL worker row 7C-001; missing_edge=final object/module+DTB+ueventd/file_contexts/allow+native caller UID/domain
...
- Confidence: **UNKNOWN**; status `UNKNOWN`
- Scope: Phase 7 KERNEL worker row 7C-002; missing_edge=compiled DTB+proc label/mode+TE allow+caller
...
- Confidence: **UNKNOWN**; status `UNKNOWN`
- Scope: Phase 7 KERNEL worker row 7C-003; missing_edge=final heap/object+node policy+SELinux allow+caller
...
- Confidence: **UNKNOWN**; status `UNKNOWN`
- Scope: Phase 7 KERNEL worker row 7C-004; missing_edge=heap enablement+final node policy+caller
...
- Confidence: **UNKNOWN**; status `UNKNOWN`
- Scope: Phase 7 KERNEL worker row 7C-005; missing_edge=final proc owner/group+file_contexts/allow+caller
...
- Confidence: **UNKNOWN**; status `UNKNOWN`
- Scope: Phase 7 KERNEL worker row 7C-006; missing_edge=final object/DT+sysfs label/mode+allow+caller
...
- Confidence: **UNKNOWN**; status `UNKNOWN`
- Scope: Phase 7 KERNEL worker row 7C-007; missing_edge=final registration+mount+policy+caller
...
- Confidence: **UNKNOWN**; status `UNKNOWN`
- Scope: Phase 7 KERNEL worker row 7C-008; missing_edge=final node+SELinux+caller
...
- Confidence: **UNKNOWN**; status `UNKNOWN`
- Scope: Phase 7 KERNEL worker row 7C-009; missing_edge=compiled DTB+sysfs policy+caller
...
- Confidence: **UNKNOWN**; status `UNKNOWN`
- Scope: Phase 7 KERNEL worker row 7C-010; missing_edge=product config/object/module+proc label+allow+caller
...
- Confidence: **UNKNOWN**; status `UNKNOWN`
- Scope: Phase 7 KERNEL worker row 7C-011; missing_edge=compiled DTB+zone provider+sysfs policy+caller
...
- Confidence: **UNKNOWN**; status `UNKNOWN`
- Scope: Phase 7 KERNEL worker row 7C-012; missing_edge=final input node policy+caller
...
- Confidence: **UNKNOWN**; status `UNKNOWN`
- Scope: Phase 7 KERNEL worker row 7C-013; missing_edge=final usbfs node policy+caller
...
- Confidence: **UNKNOWN**; status `UNKNOWN`
- Scope: Phase 7 KERNEL worker row 7C-014; missing_edge=final object+node policy+capability+caller
...
- Confidence: **UNKNOWN**; status `UNKNOWN`
- Scope: Phase 7 KERNEL worker row 7C-015; missing_edge=final hash+registration/mount+policy+caller
...
- Confidence: **CONFIRMED**; status `CONFIRMED`
- Scope: Phase 7 RUNTIME worker row 7D-001; missing_edge=Read-only re-query after any future authorized test; no mutation.
...
- Confidence: **CONFIRMED**; status `CONFIRMED`
- Scope: Phase 7 RUNTIME worker row 7D-002; missing_edge=No repeat; compare read-only preferred and resolver state only.
...
- Confidence: **CONFIRMED**; status `CONFIRMED`
- Scope: Phase 7 RUNTIME worker row 7D-003; missing_edge=No repeat; retain as negative boundary.
...
- Confidence: **CONFIRMED_NEGATIVE**; status `CONFIRMED_NEGATIVE`
- Scope: Phase 7 RUNTIME worker row 7D-004; missing_edge=No repeat; read-only package state guard only.
...
- Effect: unchanged; not required
- Confidence: **CONFIRMED_NEGATIVE**; status `CONFIRMED_NEGATIVE`
- Scope: Phase 7 RUNTIME worker row 7D-005; missing_edge=No repeat; inspect only if a future build exposes a Home selector.
...
- Confidence: **CONFIRMED_NEGATIVE**; status `CONFIRMED_NEGATIVE`
- Scope: Phase 7 RUNTIME worker row 7D-006; missing_edge=No raw transaction; only observe an authorized owner lifecycle if naturally available.
...
- Scope: Phase 7 RUNTIME worker row 7D-007; missing_edge=Only observe a genuine official restore event; do not replay payload or tx81.
...
- Scope: Phase 7 RUNTIME worker row 7D-008; missing_edge=No new child creation; if already-existing child is present, read-only resolve/foreground check only.
...
- Confidence: **CONFIRMED_NEGATIVE**; status `CONFIRMED_NEGATIVE`
- Scope: Phase 7 RUNTIME worker row 7D-009; missing_edge=Do not repeat; genuine Amazon provisioning remains untested and would require privileged GUI/private path.
...
- Confidence: **CONFIRMED_NEGATIVE**; status `CONFIRMED_NEGATIVE`
- Scope: Phase 7 RUNTIME worker row 7D-010; missing_edge=No repeat; child-only route is not a User 0 workaround.
...
- Confidence: **CONFIRMED_CHILD_ONLY**; status `CONFIRMED_CHILD_ONLY`
- Scope: Phase 7 RUNTIME worker row 7D-011; missing_edge=No repeat; read-only current-user/HOME guard only.
...
- Scope: Phase 7 RUNTIME worker row 7D-012; missing_edge=No repeat; if authorized, one read-only post-reboot foreground/resolver guard.
...
- Confidence: **CONFIRMED_NEGATIVE**; status `CONFIRMED_NEGATIVE`
- Scope: Phase 7 RUNTIME worker row 7D-013; missing_edge=No repeat; consume route closed for this build.
...
- Scope: Phase 7 RUNTIME worker row 7D-014; missing_edge=Only safe minimum is read-only monitor-state review; do not claim persistence or USB-independent operation.
...
- Scope: Phase 7 RUNTIME worker row 7D-015; missing_edge=No repeat; keep classified as observer spoof candidate, not workaround.
...
- Scope: Phase 7 RUNTIME worker row 7D-016; missing_edge=No transaction guessing; host-only caller/permission closure only.
...
- Scope: Phase 7 RUNTIME worker row 7D-017; missing_edge=Only observe after a legitimate official OTA; do not broadcast, enable OOBE, edit setup state, or run updater/recovery.
...
- Effect: not tested; not applicable
- Confidence: **UNTESTED_HIGH_IMPACT**; status `UNTESTED_HIGH_IMPACT`
- Scope: Phase 7 RUNTIME worker row 7D-018; missing_edge=Host-only native provenance join, or natural post-OTA read-only snapshot.
...
- Scope: Phase 7 WATCHDOG worker row 7E-001; missing_edge=no evidence that receiver changes enable/disable/hidden/suspended/preferred/HOME state; receiver manifest/permission edge is not present in preserved inputs
...
- Confidence: **duplicate**; status `duplicate`
- Scope: Phase 7 WATCHDOG worker row 7E-002; missing_edge=no User 0 gate; no exact shell caller or HOME resolver sink
...
- Confidence: **duplicate**; status `duplicate`
- Scope: Phase 7 WATCHDOG worker row 7E-003; missing_edge=no User 0/HOME resolver edge
...
- Confidence: **static capability**; status `static capability`
- Scope: Phase 7 WATCHDOG worker row 7E-004; missing_edge=no exported shell-writable registration or path from callback to Fire state/HOME resolver
...
- Confidence: **static capability**; status `static capability`
- Scope: Phase 7 WATCHDOG worker row 7E-005; missing_edge=no Fire literal/PM state setter/HOME sink; package tracking input is not shell-writable in preserved evidence
...
- Confidence: **bounded negative**; status `bounded negative`
- Scope: Phase 7 WATCHDOG worker row 7E-006; missing_edge=no shell-writable property setter; only property read and trusted resource/Arcus registration; deny-list consumer-to-Fire target edge missing
...
- Confidence: **static capability**; status `static capability`
- Scope: Phase 7 WATCHDOG worker row 7E-007; missing_edge=no exact Fire Launcher target or setter edge
...
- Confidence: **duplicate**; status `duplicate`
- Scope: Phase 7 WATCHDOG worker row 7E-008; missing_edge=no evidence of accepted shell mutation for Fire User 0 or resolver replacement; no new exact caller→Fire sink beyond baseline
