...
Final read-only verification after all tests: `adb/baseline/BASELINE-20260803-04/home_resolve_cmd.txt:1-2` returns Fire priority 50; `device/baseline/BASELINE-20260803-04` and `adb/baseline/BASELINE-20260803-04` hash manifests pass. The latest foreground check also reports `com.amazon.firelauncher/.Launcher` as both resumed activity and current window focus.
...
Generated evidence-index SHA-256: [ca7bacda83b2f81d0d3781ac174f67e10f37f6072a12b9377948b9a22d8e2afb]
